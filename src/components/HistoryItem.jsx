...
/**
 * HistoryItem - Timeline Move Entry
 * 
 * Typography: Fluid text scaling
 * Touch targets: Button meets minimum 44px height
 */
    ...
    <li className="relative pl-9">
      ...
      <Tooltip content={tooltipContent} side="left" align="center">
        <button
          ...
          className={`w-full rounded-btn border px-3 py-3 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 dark:focus-visible:ring-blue-500 min-h-touch ${
            active
        ...
        >
          <div className="absolute left-0 top-3 flex h-8 w-8 items-center justify-center rounded-full border border-stone-200 bg-stone-50 text-fluid-sm dark:border-slate-700 dark:bg-slate-900">
            {entry?.mark ? (
          ...
          <div className="ml-2 flex flex-col gap-1">
            <div className="flex items-center justify-between text-badge uppercase tracking-wide text-slate-500 dark:text-slate-400">
              <span>{moveLabel}</span>
              {coordinateLabel && (
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="shrink-0 text-label text-slate-500 dark:text-slate-400">
                {entry?.result}
              </span>
            </div>
          </div>
