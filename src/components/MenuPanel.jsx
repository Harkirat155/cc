...
const MenuPanel = ({
  ...
  // menuRef already declared above
  ...
  return (
    ...
    >
      ...
      {collapsed && !expanded ? (
        ...
        <div className={`flex ${width > 498 ? 'flex-row' : 'flex-col'} gap-3 items-center justify-center w-full`}>
          {/* Game actions */}
            {showNewGame && (
              <button
            ...
            {showCreateRoom && (
              <button
                onClick={(e) => { e.stopPropagation(); handleButtonClick(createRoom); }}
            ...
            {showShare && (
              <button
                onClick={(e) => { e.stopPropagation(); handleShare(); if (collapsed) setExpanded(false); }}
            ...
            {showLeave && (
              <button
                onClick={(e) => { e.stopPropagation(); handleButtonClick(leaveRoom); }}
