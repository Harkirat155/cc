...
const BoardSquare = ({ value, onClick, isWinning, index }) => {
  ...
  return (
    <Tooltip content={tooltipMessage}>
      <button
        type="button"
        className={`group relative flex aspect-square w-[clamp(70px,22vw,110px)] items-center justify-center rounded-2xl border border-slate-200/80 bg-white/80 text-4xl font-semibold text-slate-800 shadow-[0_15px_35px_-28px_rgba(15,23,42,0.75)] transition-all duration-200 ease-out dark:border-slate-700/70 dark:bg-slate-900/70 dark:text-slate-100 ${
